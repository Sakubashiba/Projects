        ...
        for event in sdl2.ext.get_events():
            ...
            if event.type == sdl2.SDL_KEYDOWN:
                if event.key.keysym.sym == sdl2.SDLK_RIGHT:
                    ...
                    break
            if event.type == sdl2.SDL_MOUSEBUTTONDOWN#sdl2.SDL_MOUSEMOTION to draw with motion:
                ...
                #print(mousey)
                try:
                    draw_lineCube(windowsurface,mousex,mousey,mousex+100,mousey,mousex+120,mousey+20,mousex+20,mousey+20,mousex,mousey+100,mousex+100,mousey+100,mousex+120,mousey+120,mousex+20,mousey+120)
