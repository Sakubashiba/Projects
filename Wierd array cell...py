            ...
            for k in range(0,20):                
                for l in range(0,20):
                    if levelArray[k][l] == 1:
                        ...
                        #levelArray[k][l] = 0
                        #levelArray[k][l-1] = 2
                    elif levelArray[k][l] == 2:
                        levelArray[k][l] = 3
                        levelArray[k-1][l] = 3
                        levelArray[k][l+1] = 3
                        levelArray[k][l-1] = 3
                        levelArray[k+1][l] = 3
                    elif levelArray[k][l] == 3:
                        levelArray[k][l] = 4
                    elif levelArray[k][l] == 4 and levelArray[k-1][l] == 4 and levelArray[k][l+1] == 4 and levelArray[k][l-1] == 4 and levelArray[k+1][l] == 4:
                        levelArray[k][l] = 5
                        levelArray[k-1][l] = 1
                        levelArray[k][l+1] = 1
                        levelArray[k][l-1] = 1
