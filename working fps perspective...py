    ...
    while running:
        ...
        for event in sdl2.ext.get_events():
            ...
            if event.type == sdl2.SDL_MOUSEMOTION:#MOUSEMOTION:
                ...
                try:
                    draw_lineCube(windowsurface,1024 - mousex -50,720 - mousey -50,1024 - mousex +50,720 - mousey - 50,1024 -mousex +50,720 - mousey +50,1024- mousex-50,720- mousey +50,2,2,1000,2,1000,700,2,700)
